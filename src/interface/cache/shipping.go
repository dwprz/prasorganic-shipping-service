...
type Shipping interface {
	CacheTrackingByShippingId(ctx context.Context, shippingId string, t *dto.ShipperRes[[]*entity.Tracking])
	...
	FindTrackingByShippingId(ctx context.Context, shippingId string) *dto.ShipperRes[[]*entity.Tracking]
